...
<body>    
        ...
        <div class="pie1">
            <h2>Imagen:</h2>
            <p>
                <?php echo $imagen ? "<img src='../recetas/cargas/{$imagen}' style='width:300px;' />" : "No se encontró imagen."; ?>
            </p>
        </div>

        <div class="pie">
            <a href='login.php' class='boton-peligro'>Volver al Inicio</a>
        </div>
